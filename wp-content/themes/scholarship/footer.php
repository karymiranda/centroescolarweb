			...
			<div class="site-info">
				<div class="mt-container">
					...
					<div class="scholarship-copyright-wrapper">
						...
						<span class="sep"> | </span>
						<?php printf( esc_html__( '%1$s by %2$s.', 'scholarship' ), 'Scholarship Theme', '<a href="'. esc_url( 'https://www.facebook.com/Cec-Santa-Mar%C3%ADa-del-Camino-1887296358255506/' ).'" rel="designer">Centro Escolar Católico Santa Maria del Camino</a>' ); ?>
					</div>
